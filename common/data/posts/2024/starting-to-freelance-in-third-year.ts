...
export const startingToFreelanceInThirdYear: PostDef = {
	...
	description:
		'Why I opened a freelance track on 1 January 2024, mid-degree, already holding a part-time dev job and a senior thesis — and what the first year actually produced.',
