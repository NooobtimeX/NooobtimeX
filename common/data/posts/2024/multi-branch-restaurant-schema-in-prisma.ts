...
export const multiBranchRestaurantSchemaInPrisma: PostDef = {
	...
	body: [
		...
		},
		{
			...
			rows: [
				['Database per branch', 'Isolation you cannot forget to apply', 'Migrations times N, and cross-branch reporting becomes a separate problem'],
				['Schema per branch', 'Strong separation, one server', 'Connection and migration complexity a solo student does not want to own'],
