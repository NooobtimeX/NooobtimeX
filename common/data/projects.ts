...
export const looklookPet: ProjectDef = {
	...
	images: { banner: '/issue/looklook-pet/banner.webp', photos: ['/issue/looklook-pet/banner.webp'] },
	skills: [
		'typescript',
		'next-js',
		'react',
...
export const rsTrophy: ProjectDef = {
	...
	images: { banner: '/issue/rs-trophy/banner.png', photos: ['/issue/rs-trophy/banner.png'] },
	skills: [
		'bun-js',
		'elysia-js',
		'next-js',
...
export const rsTrophyV1: ProjectDef = {
	...
	images: { banner: '/issue/rs-trophy-v1/banner.png', photos: ['/issue/rs-trophy-v1/banner.png'] },
...
export const prettierConfig: ProjectDef = {
	...
	images: { banner: '/issue/prettier-config/banner.png', photos: ['/issue/prettier-config/banner.png'] },
	skills: [
		'next-js',
		'react',
		'typescript',
...
export const rsMedal: ProjectDef = {
	...
	images: { banner: '/issue/rs-medal/banner.png', photos: ['/issue/rs-medal/banner.png'] },
...
export const rsAward: ProjectDef = {
	...
	images: { banner: '/issue/rs-award/banner.png', photos: ['/issue/rs-award/banner.png'] },
	skills: ['next-js', 'react', 'typescript', 'tailwind-css', 'shadcn-ui', 'vercel', 'google-ads'],
...
export const qrFood: ProjectDef = {
	...
	images: { banner: '/issue/qr-food/banner.png', photos: ['/issue/qr-food/banner.png'] },
...
export const portfolio: ProjectDef = {
	...
	images: { banner: '/issue/portfolio/banner.png', photos: ['/issue/portfolio/banner.png'] },
	skills: [
		'typescript',
		'next-js',
		'react',
