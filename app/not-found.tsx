			...
			<div className='z-10 px-4 text-center'>
				<ComicPop delay={0.2}>
					<div className='relative mb-8 inline-block'>
						<h1 className='text-primary relative z-10 text-[10rem] leading-none font-black drop-shadow-[10px_10px_0px_rgba(255,255,255,1)] md:text-[15rem]'>
							404
						</h1>
						{/* Background Text Stroke Effect */}
						<h1 className='comic-text-stroke absolute inset-0 z-0 stroke-white stroke-[20px] text-[10rem] leading-none font-black text-transparent md:text-[15rem]'>
							404
						</h1>
					</div>
				</ComicPop>
